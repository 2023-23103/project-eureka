...
image_path = 'electronic scale.png'
...
# 왼쪽 칸에는 문제를 출력합니다.
with col1:
    st.image('cylinder.png', width=200)
...
with col2:
      ...
      st.image('volume calibration.png', width=250)
      st.image('cylinder2.png', width=250)
